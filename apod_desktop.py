...
def get_apod_date():
    ...
    if apod_date == date.fromisoformat:
     try:
...
def get_apod_info(image_id):
    ...
    cur = con.cursor()
    image_info= """
            SELECT title, explanation, and full path FROM image_cache_db
            """
    cur.execute(image_info,image_id)
    con.close()
